...
const transferCreditPrefix= 'transferCredit';
const paymentFlowPrefix= 'paymentFlow';
...
const nftBasicInfoKey = 'basicinfo';
const nftPriceInfoKey = 'priceinfo';
const nftCheckDataKey = 'checkdata';
const nftTicketDataKey = 'ticketdata';
const nftStockKey = 'stockinfo';
const stockArrayKey = 'stockArray';
...
const STORAGE_CREDIT = '1';  // 保存预授信信息
const STORAGE_TRANSFER = '2';  // 保存预授信转账信息
const STORAGE_BANK = '3';  // 保存银行流水信息
const STORAGE_ACTIVATE = '4';  // 保存交易所还款信息
