      ...
      chrome.storage.local.get(['authorizedAccounts'], (result) => {
        ...
        if (reqId) {
          ...
          if (isAuthorized) {
            ...
            if(origin == 'http://localhost:3000' || origin == 'http://192.168.120.32' || 'http://192.168.50.41/') {
              navigate('/authorize', {
                state: {
                  origin,
                  requestId: reqId,
          ...
          if (!isAuthorized) {
            if(origin == 'http://localhost:3000'|| origin == 'http://192.168.120.32' || origin == 'http://192.168.50.41/') {
              navigate('/authorize', {
                state: {
                  origin,
                  requestId: reqId,
